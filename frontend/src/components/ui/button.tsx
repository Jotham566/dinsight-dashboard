  ...
  'inline-flex items-center justify-center whitespace-nowrap font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-95',
  {
    variants: {
      variant: {
        ...
        gradient: 'bg-gradient-to-r from-primary-500 via-accent-purple-500 to-accent-pink-500 text-white shadow-lg hover:shadow-xl hover:scale-105',
        glass: 'bg-white/10 dark:bg-gray-900/10 backdrop-blur-xl border border-white/20 dark:border-gray-700/20 text-gray-900 dark:text-gray-100 hover:bg-white/20 dark:hover:bg-gray-800/20',
      },
      size: {
