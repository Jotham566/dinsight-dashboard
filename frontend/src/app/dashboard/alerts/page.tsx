...
// /dashboard/alerts is the active-alerts feed: rows fired by rules
// against stored anomaly classifications. Rule MANAGEMENT (create,
// edit, delete) lives under Account & Security → Alert rules so the
// settings surface stays consolidated. This page is just the
// operational view.
    ...
    <div className="space-y-6">
      <Card className="border-border/60">
        <CardHeader>
          ...
          <CardDescription>
            Rows fired by alert rules against stored anomaly classifications. Acknowledge or resolve
            from here. To manage the rules themselves, open{' '}
            <a
              href="/dashboard/account?section=alert-rules"
              className="font-medium text-accent hover:underline"
            >
              Account &amp; Security → Alert rules
            </a>
            .
          </CardDescription>
        </CardHeader>
